...
function AngleVisualizer() {
  ...
  return (
    <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-4 sm:p-6 md:p-8 rounded-xl border-2 sm:border-4 border-primary mt-6 sm:mt-8 overflow-hidden">
